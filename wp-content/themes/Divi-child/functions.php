...
add_filter('gettext', 'promeni_relatedproducts_text', 10, 3);

function promeni_relatedproducts_text($new_text, $related_text, $source)
{
...
//Change cart Product text 

add_filter('gettext', 'promeni_cart_text', 10, 3);

function promeni_cart_text($new_text, $related_text, $source)
{
